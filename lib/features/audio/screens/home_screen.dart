    ...
    return _buildSectionCard(
      ...
      children: [
        _buildTeamMemberCard(
          ...
          members: [
            {'nameLao': 'ທ້າວ ເອກທະວີພົນ ທອງເພັດ', 'nameEng': 'Mr. Ekthaviphonh THONGPHET', 'email': 'ekthaviphonhthongphet@gmail.com', 'phone': '020 59 179 444'},
    ...
    final instruments = [
        {
          ...
          'fullDescription': '''ແຄນແມ່ນເຄື່ອງດົນຕີທີ່ຖືວ່າເປັນເຄື່ອງດົນຕີປະຈຳຊາດຂອງລາວ. ມັນຖືກສ້າງຂຶ້ນຈາກທໍ່ໄມ້ໄຜ່ຫຼາຍອັນທີ່ຖືກຕິດຕັ້ງດ້ວຍລີ້ນໂລຫະ. ແຄນມີຕົ້ນກຳເນີດຈາກເຂດຊົນນະບົດ ແລະ ມີຄວາມສໍາພັນກັບເຄື່ອງດົນຕີປະເພດອື່ນໆທີ່ພົບເຫັນໃນເຂດອາຊີຕາເວັນອອກ ແລະ ອາຊີຕາເວັນອອກສ່ຽງໃຕ້, ອາດມີຕົ້ນກຳເນີດມາຈາກເຄື່ອງດົນຕີຈີນທີ່ເອີ້ນວ່າ "sheng". ມັນຖືກນໍາໃຊ້ເປັນເວລາຫຼາຍສະຕະວັດໃນລາວ ແລະ ພາກຕາເວັນອອກສຽງເໜືອຂອງໄທ (ອີສານ), ມັກຈະເຂົ້າຄູ່ກັບນັກຮ້ອງ (ໝໍລຳ) ໃນສະພາບແວດລ້ອມທາງສັງຄົມ ແລະ ພິທີກຳຕ່າງໆ. ດົນຕີແຄນເປັນສ່ວນສຳຄັນຂອງຊີວິດຄົນລາວ, ສົ່ງເສີມຄວາມສາມັກຄີໃນຄອບຄົວ ແລະ ສັງຄົມ.
      UNESCO. (n.d.). ໃນປີ 2017, ແຄນລາວໄດ້ຖືກຂຶ້ນທະບຽນເປັນມໍລະດົກທາງວັດທະນະທໍາທີ່ບໍ່ແມ່ນວັດຖຸຂອງມວນມະນຸດຈາກອົງການ UNESCO. ແຄນສາມາດສ້າງສຽງທີ່ອຸດົມສົມບູນດ້ວຍສຽງຄູ່ (polyphonic) ທີ່ມີທັງສຽງພື້ນ (drone) ແລະ ສຽງທຳນອງ. ນັກດົນຕີຈະເປົ່າ ຫຼື ດຶງອາກາດຜ່ານກ່ອງລົມໃນຂະນະທີ່ປິດຮູນິ້ວຢູ່ທໍ່ໄມ້ໄຜ່ເພື່ອສ້າງລະດັບສຽງທີ່ແຕກຕ່າງກັນ. ສຽງສາມາດທັ່ງນຸ້ມນວນ ແລະ ມີຊີວິດຊີວາ, ຂຶ້ນກັບວິທີການຫຼິ້ນ ແລະ ໄລ (lai) ຫຼື ໂໝດ (mode) ສະເພາະທີ່ໃຊ້.''',
        },
        {
          'name': 'ຊໍອູ້',
          'eng': 'So U',
      ...
      ຊໍອູ້ມີສຽງທີ່ເລິກ, ແລະ ນຸ້ມນວນ. ມັນຖືກໃຊ້ເລື້ອຍໆເພື່ອເປັນພື້ນຖານຂອງວົງດົນຕີ, ໂດຍສະເພາະສຳລັບທຳນອງທີ່ມີຈັງຫວະຊ້າຫາປານກາງ. ກ່ອງສຽງທີ່ເຮັດຈາກໝາກພ້າວປະກອບສ່ວນໃຫ້ເກີດສຽງກ້ອງສະເພາະຕົວຂອງມັນ.''',
        },
        {
          ...
          'fullDescription': '''ໃນບໍລິບົດຂອງດົນຕີລາວ, "ຊິ່ງ" ໝາຍເຖິງເຄື່ຶອງທີ່ໃຊ້ເພື່ອສ້າງຈັງຫວະ. ໃນວົງເຊບໃຫຍ່ (ວົງດົນຕີພື້ນເມືອງລາວ), ມີແຜ່ນສອງຊຸດ (ຊິ່ງ, ຄ້າຍຄື ໄທຫຼື "ຈິ່ງ") ທີ່ຖືກລວມເຂົ້າເປັນເຄື່ອງດົນຕີທີ່ເນັ້ນຈັງຫວະ. ຊິ່ງມີປະຫວັດສາດອັນຍາວນານໃນຫຼາຍວັດທະນະທໍາ ແລະ ການໃຊ້ຊິ່ງໃນດົນຕີພື້ນເມືອງລາວເປັນສ່ວນໜຶ່ງຂອງປະເພນີວົງເຄື່ອງຕີ.
      ຊິ່ງສ້າງສຽງທີ່ແຈ້ງກະຈ່າງ, ກະທົບ ແລະ ກ້ອງທີ່ໃຊ້ເພື່ອກຳນົດວົງຈອນຂອງຈັງຫວະ ແລະ ເນັ້ນຈຸດສຳຄັນໃນດົນຕີ. ສຽງສະເພາະຂຶ້ນກັບຂະໜາດ, ຄວາມໜາ ແລະ ໂລຫະປະສົມຂອງຊິ່ງ ເຊັ່ນດຽວກັບວິທີການຕີ.''',
        },
        {
          'name': 'ພິນ',
          'eng': 'Phin',
          ...
          'fullDescription': '''ພິນແມ່ນເຄື່ອງດົນຕີປະເພດລູດທີ່ມີຮູບຮ່າງຄ້າຍຄືໝາກສາລີ, ມີຕົ້ນກຳເນີດໃນລາວ ແລະ ພາກອີສານຂອງໄທ ສ່ວນໃຫຍ່ຫຼິ້ນໂດຍຄົນເຊື້ອຊາດລາວໃນໄທ ແລະ ລາວ. ໂດຍທົ່ວໄປ, ມັນມີສາຍໂລຫະສອງຫຼືສາມເສັ້ນທີ່ຖືກຂຶງຜ່ານຄໍທີ່ມີເຟຣັດ ແລະ ຖືກດີດດ້ວຍວິ ຫຼື ປິກ. ມັນມັກຈະຫຼິ້ນຄູ່ກັບແຄນໃນດົນຕີໝໍລຳ ແລະ ລູກທຸ່ງ. ໂຕ ແລະ ຄໍມັກຈະຖືກແກະສະຫຼັກຈາກໄມ້ທ່ອນດຽວ.
      ພິນສ້າງສຽງທີ່ແຈ້ງ, ແຫລມ, ທີ່ມີສຽງສັ້ນພໍສົມຄວນ. ສຽງຂອງມັນເປັນລັກສະນະສະເພາະຂອງດົນຕີໝໍລຳ ແລະ ລູກທຸ່ງ, ໃຫ້ການປະກອບຈັງຫວະ ແລະ ທຳນອງໃຫ້ກັບສຽງຮ້ອງ ແລະ ແຄນ.''',
        },
        {
          'name': 'ຄ້ອງວົງ',
          'eng': 'Khong Vong',
          ...
          'fullDescription': '''ຄ້ອງວົງໝາຍເຖິງຊຸດຄ້ອງທີ່ຈັດວາງໃນກອບວົງມົນ. ເຄື່ອງດົນຕີປະເພດນີ້ມີຮູບແບບຕ່າງໆໃນທົ່ວອາຊີຕາເວັນອອກສຽງໃຕ້. ໃນວົງດົນຕີຄລາສສິກລາວ (ເຊບໃຫຍ່), ໂດຍທົ່ວໄປມີຊຸດຄ້ອງ (ຄ້ອງວົງ) ສອງຊຸດ. ວົງຄ້ອງເຫຼົ່ານີ້ອາດມີຕົ້ນກຳເນີດບູຮານ, ພັດທະນາຜ່ານຫຼາຍສະຕະວັດ ແລະ ຖືກລວມເຂົ້າໃນດົນຕີລາຊະອານະຈັກ ແລະ ດົນຕີປະກອບພິທີກຳ.
      ຄ້ອງວົງສ້າງສຽງຄ້ອງທີ່ປັບລະດັບສຽງຊຶ່ງສາມາດສ້າງທັງຮູບແບບທຳນອງ ແລະ ຈັງຫວະ. ສຽງກ້ອງ ແລະ ລະດັບສຽງຂອງຄ້ອງແຕ່ລະໜ່ວຍຂຶ້ນກັບຂະໜາດ ແລະ ວັດສະດຸທີ່ໃຊ້ (ໂດຍທົ່ວໄປແມ່ນທອງແດງຫຼື ທອງເຫຼືອງ). ໃນວົງດົນຕີ, ຄ້ອງວົງສອງຊຸດ (ຊຸດໜຶ່ງສຽງສູງກວ່າ, ອີກຊຸດສຽງຕໍ່າກວ່າ) ຮ່ວມກັນສ້າງທຳນອງແລະລວດລາຍທີ່ຊັບຊ້ອນ.''',
        },
        {
          'name': 'ລະນາດ',
          'eng': 'Lanat',
          ...
          'fullDescription': '''ລະນາດແມ່ນຄຳທົ່ວໄປສຳລັບເຄື່ອງດົນຕີປະເພດເຄາະທີ່ມີຮູບຄີບອດໃນດົນຕີລາວ. ໄມ້ຕີສາມາດເຮັດຈາກໄມ້ແຂງຫຼືໄມ້ໄຜ່ (ລະນາດເອກ ແລະ ລະນາດທຸ້ມ), ໂລຫະ (ລະນາດເອກເຫຼັກ ແລະ ລະນາດທຸ້ມເຫຼັກ), ຫຼືບາງຄັ້ງກໍ່ເຮັດຈາກແກ້ວ (ລະນາດແກ້ວ). ຮູບແບບດັ້ງເດີມທີ່ສຸດໄດ້ວິວັດທະນາຈາກເຄື່ອງດົນຕີແບບງ່າຍໆທີ່ໃຊ້ຮັກສາຈັງຫວະ ໄປເປັນຊຸດໄມ້ທີ່ປັບລະດັບສຽງ.
      ສຽງຂອງລະນາດແຕກຕ່າງກັນໄປຂຶ້ນກັບວັດສະດຸຂອງໄມ້ຕີ ແລະ ໄມ້ທີ່ໃຊ້. ໄມ້ສ້າງສຽງທີ່ສົດໃສ, ແລະກະທົບ, ໃນຂະນະທີ່ໂລຫະມີສຽງທີ່ແຈ້ງກະຈ່າງ, ກ້ອງກວ່າ. ໄມ້ຕີຕ່າງໆ (ແຂງຫຼືນຸ້ມ) ຖືກໃຊ້ເພື່ອໃຫ້ໄດ້ສີສຽງທີ່ແຕກຕ່າງກັນ. ລະນາດເອກໂດຍທົ່ວໄປຫຼິ້ນທຳນອງຫຼັກດ້ວຍສຽງທີ່ຄົມ ແລະ ແຈ້ງຊັດ, ໃນຂະນະທີ່ລະນາດທຸ້ມໃຫ້ສຽງທີ່ຕໍ່າກວ່າ, ມັກຈະເປັນທຳນອງປະກອບ.''',
        },
      ];
    return _buildFrostedCard(
      child: Column(
